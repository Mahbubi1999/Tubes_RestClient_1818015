...
<?php echo form_open_multipart('rental_ps/create');?>
<table>
    <tr><td>Nama</td><td><?php echo form_input('Nama');?></td></tr>
    <tr><td>Pembuat</td><td><?php echo form_input('Pembuat');?></td></tr>   
    <tr><td>Tahun_Produksi</td><td><?php echo form_input('Tahun_Produksi');?></td></tr>
    <tr><td>Harga_Sewa</td><td><?php echo form_input('Harga_Sewa');?></td></tr> 
    <tr><td>Kapasitas</td><td><?php echo form_input('kapasitas');?></td></tr>   
